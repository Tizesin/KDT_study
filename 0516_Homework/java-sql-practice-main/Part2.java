...
public class Part2 {
  ...
  */
  public static final String PART2_3 = "insert into users(username,email,password) values ('minjun','tlsalswns0o@naver.com', '1234')";
  ...
  */
  ...
  /*
  ----------------------------------------------------------------------------------------------
      TODO: Q 2-8. posts의 title과 그 게시글을 작성한 users의 username을 찾기 위한 SQL을 작성해주세요.
  ...
  */
  public static final String PART2_10 = "insert into posts(title,content,user_id,created_at) " +
          "values ('i want to go home', 'i am so hungry. so i want to go home now. plz let me go', 1, CURRENT_TIMESTAMP)";
  ...
  */
  public static final String PART2_12 = "select p.title from posts p " +
          "join users u on p.user_id = u.user_id " +
          "where p.user_id = 1";
  ...
  */
  public static final String PART2_13 = "select b.name from boards b " +
  ...
  */
  public static final String PART2_15 = "select count(*) as CommentCount from comments c " +
  ...
  */
  public static final String PART2_16 = "select u.username, count(comment_id) as CommentCount from comments c " +
  ...
  */
  public static final String PART2_17 = "select b.name, count(post_id) as PostCount from boards b " +
          "join posts p on b.board_id = p.board_id " +
          "group by b.name";
  ...
  */
  public static final String PART2_18 = "select b.name, avg(CHAR_LENGTH(p.content)) as AvgLength from boards b " +
  ...
  */
  public static final String PART2_19 = "select b.name, avg(CHAR_LENGTH(p.content)) as AvgLength from boards b " +
          "left join posts p on b.board_id = p.board_id " +
